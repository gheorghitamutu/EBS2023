...
class ComplexSubscription:
    ...
    def is_valid(self) -> bool:
        return not self.entities[ComplexPublication.CITY] or not self.entities[ComplexPublication.AVERAGE_TEMPERATURE] \
            or not self.entities[ComplexPublication.AVERAGE_RAIN] or not self.entities[ComplexPublication.AVERAGE_WIND]
